...
See [eq/cards/canonical-migration/plan.md](../eq/cards/canonical-migration/plan.md) for the full 5-unit plan.
...
[eq/identity/PHASE-1F-PLAN.md](../eq/identity/PHASE-1F-PLAN.md) got a "Context update — 2026-05-20 evening" preface flagging two things the morning draft didn't include:
...
1. Read [eq/identity/IDENTITY-MODEL.md](../eq/identity/IDENTITY-MODEL.md) + [eq/identity/PHASE-1F-PLAN.md](../eq/identity/PHASE-1F-PLAN.md) end-to-end. The Context update at the top of the latter is the diff vs the morning draft.
2. Read [eq/cards/canonical-migration/plan.md](../eq/cards/canonical-migration/plan.md) for context on what Step 4 (mint-supabase-jwt) unblocks.
...
- [eq/cards/canonical-migration/plan.md](../eq/cards/canonical-migration/plan.md) — the multi-unit Cards plan; Unit 4 blocked on Phase 1.F
- [eq/identity/IDENTITY-MODEL.md](../eq/identity/IDENTITY-MODEL.md) — cross-product identity spec
- [eq/identity/PHASE-1F-PLAN.md](../eq/identity/PHASE-1F-PLAN.md) — Phase 1.F implementation plan (now with Context update preface)
