...
† Budget: ~150 lines, stated in the file itself (`system/worktree-registry.md`, added 2026-09-07). The other five budgetless columns (`eq/pending/*`, `lessons.md`, `failures.md`) are this protocol's own still-open finding — see `ops/pending.md`.
