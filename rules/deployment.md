...
|------|---------------|---------|--------------|
| eq-solves-field.netlify.app | Netlify Drop (manual zip) | dev@eq.solutions | Explicit instruction only |
...
| eq-expenses.netlify.app | Netlify Drop | dev@eq.solutions | Explicit instruction only |
| eq-variations.netlify.app | Netlify Drop | dev@eq.solutions | Explicit instruction only |
