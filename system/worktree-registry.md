...
|--------|--------|-----------------|---------|--------|
| .claude/worktrees/sks-comms-resource-mgmt-7563e2 (eq-shell) | claude/sks-comms-resource-mgmt-7563e2 | Claude (NSW Comms Move 1 — migration 0169 job-card fields + job_id seam on schedule_entries, comms page upgrade, planner backfill dry-run) | 2026-07-10 | ACTIVE |
