...
|--------|--------|-----------------|---------|--------|
| C:\Projects\eq-shell-cpledger-wt (eq-shell) | claude/tombstone-cross-plane-migrations | Claude (foreman: control-plane ledger + follow-ups) | 2026-07-11 | DONE — #729 (ledger doc) MERGED; 2026_06_27b revoke APPLIED to live jvkn (verified true→false); #730 (tombstone 3 cross-plane files) MERGED `b952ecb` (branch auto-deleted). Worktree dir removable. |
