...
|--------|--------|-----------------|---------|--------|
| .claude/worktrees/sks-comms-resource-mgmt-7563e2 (eq-shell) | claude/sks-comms-resource-mgmt-7563e2 | Claude (NSW Comms Move 1 — migration 0169 job-card fields + job_id seam on schedule_entries, comms page upgrade, planner backfill) | 2026-07-10 | DONE — PR #727 MERGED (squash d7e7787); 0169 applied to ehow + 153-job planner backfill run & verified; Netlify auto-deploy triggered. Dir reusable for Move 2. |
