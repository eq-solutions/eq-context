...
| .claude/worktrees/sks-comms-resource-mgmt-7563e2 (eq-shell) | claude/comms-fortnight | Claude (NSW Comms Moves 1 / 1.5 / 2b / 2c) | 2026-07-10 | ALL MERGED: Move 1 #727 (d7e7787, 0169+153-job backfill live); 1.5+2b #731 (7013d34, filters + crew-booking→schedule_entries); 2c #738 MERGED (squash 6a51784) — fortnight capacity grid (read-only roster read). Comms UI + read-only fn, no new migration. Deploying. Next: NV1-as-licence, comms-crew tag. |
