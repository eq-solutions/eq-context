...
|--------|--------|-----------------|---------|--------|
| C:\Projects\eq-shell-cpledger-wt (eq-shell) | claude/tombstone-cross-plane-migrations | Claude (foreman: control-plane ledger + follow-ups) | 2026-07-11 | #729 (ledger doc) MERGED; 2026_06_27b revoke APPLIED to live jvkn (verified); #730 (tombstone 3 cross-plane files) OPEN for Royce's merge. Dir removable after #730. |
| .claude/worktrees/sks-comms-resource-mgmt-7563e2 (eq-shell) | claude/comms-move15-filters (was …-7563e2) | Claude (NSW Comms Move 1 DONE; now Move 1.5 filters+simplification) | 2026-07-10 | Move 1 DONE (PR #727 MERGED squash d7e7787; 0169 + 153-job backfill live). Move 1.5 = PR #731 OPEN (filters + declutter, comms UI only, no migration). Branch re-cut off main via cherry-pick to dodge squash-merge divergence. |
