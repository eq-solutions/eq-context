...
| .claude/worktrees/sks-comms-resource-mgmt-7563e2 (eq-shell) | claude/comms-move15-filters | Claude (NSW Comms Moves 1 / 1.5 / 2b) | 2026-07-10 | ALL MERGED: Move 1 #727 (squash d7e7787, 0169+153-job backfill live); Moves 1.5+2b #731 MERGED (squash 7013d34) — filters/declutter + crew-booking→schedule_entries. Comms UI only, no new migration. Netlify auto-deploy triggered. Dir reusable for next move (fortnight/capacity grid). |
