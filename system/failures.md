...
failures:
  ...
  - id: F4
    title: Core product workflow has 0% completion and nothing surfaced it
    first_seen: 2026-07-11
    recurrences: 1
    rung: 0
    target_rung: 3
    guard: "none -> product signals in digest.md (rung 3)"
    detected_by: "human — an ad-hoc live SQL query"
    cost: "14 maintenance checks created, 0 ever completed. Unknown duration. Unknown business cost."
    note: "16 CI workflows watch the repos. ZERO watch the product."
