...
_Last verified: 2026-07-12 (nightly cron)_
...
| Assets | 568 | app_data.assets |
| Tenants | 1 (SKS Technologies) | service.tenants |
| Users | 5 | service.tenant_members |
| Maintenance checks | 16 | service.maintenance_checks |
...
**eq-cards:**
- #151 fix(onboarding): pending application no longer dead-ends to personal wallet
...
## System Health (as of 2026-07-12)
