...
**eq-shell:**
- #1715 fix(admin): clear react-hooks/set-state-in-effect on Users list fetch
- #1714 fix(admin): clear react-hooks/set-state-in-effect on worker-invites fetch
- #1710 fix(auth): rate-limit shell-join-tenant.ts, matching its login sibling
