...
_Last verified: 2026-08-03 (nightly cron)_
...
**eq-cards:**
- #208 fix(auth): orphan guard on custom_access_token_hook's phone-fallback
...
**eq-shell:**
- #1229 fix(auth): guard shell-join-tenant's existing-user phone match against orphans
- #1228 fix(documents): sign-off reminder cadence to a uniform 7 days
