...
_2026-08-30 09:28 UTC · what needs your attention. Full snapshot: [suite-state.md](suite-state.md)._

## Since last refresh (2026-08-30 09:17 UTC → 2026-08-30 09:28 UTC)
...
_…and 250 more · [eq/pending.md](eq/pending.md) · [sks/pending.md](sks/pending.md) · [ops/pending.md](ops/pending.md)_
...
| 2026-08-30 | eq-field | [#844](https://github.com/eq-solutions/eq-field/pull/844) v3.5.615 — FIX: leave requests from non-manager accounts could sa |
...
- **eq-field** (173 open) · [eq/pending/eq-field.md](eq/pending/eq-field.md)
...
- **cross-repo** (171 open) · [eq/pending/cross-repo.md](eq/pending/cross-repo.md)
...
| [eq-cards](eq/pending/eq-cards.md) | 322 | 40 / 17 | 12 | 6 |
| [eq-field](eq/pending/eq-field.md) | 1017 | 133 / 50 | 25 | 33 |
| [eq-solves-service](eq/pending/eq-solves-service.md) | 541 | 73 / 26 | 1 | 27 |
| [eq-solves-intake](eq/pending/eq-solves-intake.md) | 146 | 13 / 6 | 0 | 17 |
...
| [eq-context](eq/pending/eq-context.md) | 212 | 27 / 6 | 1 | 4 |
| [cross-repo](eq/pending/cross-repo.md) | 880 | 128 / 43 | 2 | 60 |
...
---
_Generated deterministically (no LLM) by `.github/scripts/refresh_digest.py` · on merge + nightly · 2026-08-30 09:28 UTC._
