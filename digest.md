...
_2026-06-30 11:49 UTC · what needs your attention. Full snapshot: [suite-state.md](suite-state.md)._

## Since last refresh (2026-06-30 11:48 UTC → 2026-06-30 11:49 UTC)
...
- Merged: eq-solves-service [#376](https://github.com/eq-solutions/eq-service/pull/376) Fail closed on unresolved Shell→Service tenant slug (audit g
...
---
_Generated deterministically (no LLM) by `.github/scripts/refresh_digest.py` · on merge + nightly · 2026-06-30 11:49 UTC._
