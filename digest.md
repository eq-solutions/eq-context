...
_2026-08-16 09:17 UTC · what needs your attention. Full snapshot: [suite-state.md](suite-state.md)._

## Since last refresh (2026-08-16 09:13 UTC → 2026-08-16 09:17 UTC)
...
- Merged: eq-solves-service [#735](https://github.com/eq-solutions/eq-service/pull/735) fix(security): enforce write roles in the database, not just
...
---
_Generated deterministically (no LLM) by `.github/scripts/refresh_digest.py` · on merge + nightly · 2026-08-16 09:17 UTC._
