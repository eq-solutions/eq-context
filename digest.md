...
_2026-07-30 20:15 UTC · what needs your attention. Full snapshot: [suite-state.md](suite-state.md)._

## Since last refresh (2026-07-30 20:13 UTC → 2026-07-30 20:15 UTC)
...
- Merged: eq-solves-service [#656](https://github.com/eq-solutions/eq-service/pull/656) feat(reports): fold Customer Report into Send Report to Cust
...
|------|------:|-----:|------------------:|------------:|
| [EQ](eq/pending.md) | 2847 | 457 | 83 | 9 |
...
---
_Generated deterministically (no LLM) by `.github/scripts/refresh_digest.py` · on merge + nightly · 2026-07-30 20:15 UTC._
