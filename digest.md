...
_2026-09-02 12:33 UTC · what needs your attention. Full snapshot: [suite-state.md](suite-state.md)._

## Since last refresh (2026-09-02 12:29 UTC → 2026-09-02 12:33 UTC)
...
| Merged | Repo | PR |
|--------|------|----|
| 2026-09-02 | eq-shell | [#1751](https://github.com/eq-solutions/eq-shell/pull/1751) feat(documents): new-version upload, version history, confirm-the |
| 2026-09-02 | eq-shell | [#1750](https://github.com/eq-solutions/eq-shell/pull/1750) perf(prewarm): stagger eager iframe pre-warm — Field first, then  |
| 2026-09-02 | eq-shell | [#1749](https://github.com/eq-solutions/eq-shell/pull/1749) perf: lazy-load Staff, Customers, and the two portal pages (Tier  |
...
| 2026-09-02 | eq-field | [#896](https://github.com/eq-solutions/eq-field/pull/896) v3.5.653 — Weekly Roster: the roster table is the landing view ag |
| 2026-09-02 | eq-field | [#894](https://github.com/eq-solutions/eq-field/pull/894) v3.5.652 — Edit Roster: "fill week" is now plain Enter, never ove |
| 2026-09-02 | eq-field | [#892](https://github.com/eq-solutions/eq-field/pull/892) v3.5.650 -- Apprentices: journal sharing replaces Ask-for-Feedbac |
| 2026-09-02 | eq-field | [#891](https://github.com/eq-solutions/eq-field/pull/891) v3.5.650 — Batch Fill: never write over someone's approved leave |
...
- **eq-field** (218 open) · [eq/pending/eq-field.md](eq/pending/eq-field.md)
...
| [eq-field](eq/pending/eq-field.md) | 1184 | 157 / 69 | 41 | 33 |
...
---
_Generated deterministically (no LLM) by `.github/scripts/refresh_digest.py` · on merge + nightly · 2026-09-02 12:33 UTC._
