...
_2026-09-08 19:19 UTC · what needs your attention. Full snapshot: [suite-state.md](suite-state.md)._

## Since last refresh (2026-09-08 19:08 UTC → 2026-09-08 19:19 UTC)
...
| eq-shell | [TypeError: 'text/html' is not a valid JavaScript MIME type.](https://eq-solutions.sentry.io/issues/145673876/) | 1 | 2026-09-08 |
| eq-field | [ReferenceError: _isPhoneViewport is not defined](https://eq-solutions.sentry.io/issues/145668949/) | 1 | 2026-09-08 |
| eq-shell | [auth-stall: render-crash](https://eq-solutions.sentry.io/issues/140924723/) | 1 | 2026-09-08 |
...
| 2026-09-08 | eq-field | [#944](https://github.com/eq-solutions/eq-field/pull/944) v3.5.697 — Shell handoff: fix silent SKS boot hang past Shell's 3 |
...
- **eq-field** (243 open) · [eq/pending/eq-field.md](eq/pending/eq-field.md)
...
|------|------:|------------------:|------------------:|------------:|
| [eq-shell](eq/pending/eq-shell.md) | 1480 | 205 / 91 | 1 | 78 |
| [eq-cards](eq/pending/eq-cards.md) | 355 | 48 / 17 | 0 | 9 |
| [eq-field](eq/pending/eq-field.md) | 1246 | 179 / 69 | 26 | 48 |
...
---
_Generated deterministically (no LLM) by `.github/scripts/refresh_digest.py` · on merge + nightly · 2026-09-08 19:19 UTC._
