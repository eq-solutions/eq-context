...
_2026-07-28 10:05 UTC · what needs your attention. Full snapshot: [suite-state.md](suite-state.md)._

## Since last refresh (2026-07-28 10:03 UTC → 2026-07-28 10:05 UTC)
...
- Merged: eq-solves-service [#628](https://github.com/eq-solutions/eq-service/pull/628) Map LVACB-5A frequency suffix to 5yr
...
---
_Generated deterministically (no LLM) by `.github/scripts/refresh_digest.py` · on merge + nightly · 2026-07-28 10:05 UTC._
