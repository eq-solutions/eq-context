...
_2026-08-26 09:57 UTC · what needs your attention. Full snapshot: [suite-state.md](suite-state.md)._

## Since last refresh (2026-08-26 09:54 UTC → 2026-08-26 09:57 UTC)
...
_…and 224 more · [eq/pending.md](eq/pending.md) · [sks/pending.md](sks/pending.md) · [ops/pending.md](ops/pending.md)_
...
| 2026-08-26 | eq-field | [#800](https://github.com/eq-solutions/eq-field/pull/800) v3.5.577 — Contacts: off-roster people no longer default-visible |
...
| 2026-08-26 | eq-cards | [#323](https://github.com/eq-solutions/eq-cards/pull/323) fix(migrations): re-apply RLS-initplan/FK-index hardening to 8 po |
...
- **eq-shell** (280 open) · [eq/pending/eq-shell.md](eq/pending/eq-shell.md)
- **eq-cards** (49 open) · [eq/pending/eq-cards.md](eq/pending/eq-cards.md)
- **eq-field** (142 open) · [eq/pending/eq-field.md](eq/pending/eq-field.md)
...
|------|------:|------------------:|------------------:|------------:|
| [eq-shell](eq/pending/eq-shell.md) | 1831 | 196 / 84 | 247 | 47 |
| [eq-cards](eq/pending/eq-cards.md) | 459 | 37 / 16 | 101 | 5 |
| [eq-field](eq/pending/eq-field.md) | 941 | 111 / 36 | 66 | 27 |
...
| [cross-repo](eq/pending/cross-repo.md) | 986 | 144 / 42 | 30 | 53 |
...
---
_Generated deterministically (no LLM) by `.github/scripts/refresh_digest.py` · on merge + nightly · 2026-08-26 09:57 UTC._
