...
_2026-07-22 11:46 UTC · what needs your attention. Full snapshot: [suite-state.md](suite-state.md)._

## Since last refresh (2026-07-22 11:20 UTC → 2026-07-22 11:46 UTC)
...
- Merged: eq-solves-service [#582](https://github.com/eq-solutions/eq-service/pull/582) fix(maintenance,assets): show real Asset # instead of empty 
...
---
_Generated deterministically (no LLM) by `.github/scripts/refresh_digest.py` · on merge + nightly · 2026-07-22 11:46 UTC._
