...
_2026-08-16 08:56 UTC · what needs your attention. Full snapshot: [suite-state.md](suite-state.md)._

## Since last refresh (2026-08-16 08:55 UTC → 2026-08-16 08:56 UTC)
...
- **The database-level backstop is written but not yet applied to the real database** — it goes through the normal, separately-approved database update process, not automatic. _(added 2026-08-16)_
...
|------|------:|------------------:|------------------:|------------:|
| [EQ](eq/pending.md) | 3726 | 499 / 147 | 156 | 64 |
...
---
_Generated deterministically (no LLM) by `.github/scripts/refresh_digest.py` · on merge + nightly · 2026-08-16 08:56 UTC._
