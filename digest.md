...
_2026-08-20 10:21 UTC · what needs your attention. Full snapshot: [suite-state.md](suite-state.md)._

## Since last refresh (2026-08-20 10:14 UTC → 2026-08-20 10:21 UTC)
...
- Merged: eq-solves-service [#784](https://github.com/eq-solutions/eq-service/pull/784) fix(site-credentials): move to service schema, fix pgcrypto 
...
---
_Generated deterministically (no LLM) by `.github/scripts/refresh_digest.py` · on merge + nightly · 2026-08-20 10:21 UTC._
