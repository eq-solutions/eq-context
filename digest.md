...
_2026-08-19 18:55 UTC · what needs your attention. Full snapshot: [suite-state.md](suite-state.md)._

## Since last refresh (2026-08-19 18:43 UTC → 2026-08-19 18:55 UTC)
...
_…and 163 more · [eq/pending.md](eq/pending.md) · [sks/pending.md](sks/pending.md) · [ops/pending.md](ops/pending.md)_
...
| Merged | Repo | PR |
|--------|------|----|
| 2026-08-19 | eq-shell | [#1465](https://github.com/eq-solutions/eq-shell/pull/1465) perf(staff): warm staff-bootstrap so Staff loads don't eat a 3s c |
...
| 2026-08-19 | eq-solves-service | [#766](https://github.com/eq-solutions/eq-service/pull/766) feat(contract-scope): classification gate for date_certainty |
| 2026-08-19 | eq-solves-service | [#768](https://github.com/eq-solutions/eq-service/pull/768) fix(dashboard): surface Supabase query errors instead of renderin |
| 2026-08-19 | eq-solves-service | [#769](https://github.com/eq-solutions/eq-service/pull/769) fix(pages): surface Supabase query errors instead of rendering em |
| 2026-08-19 | eq-solves-service | [#767](https://github.com/eq-solutions/eq-service/pull/767) fix(contract-scope): default Year filter to All Years, not curren |
...
- **eq-shell** (219 open) · [eq/pending/eq-shell.md](eq/pending/eq-shell.md)
...
|------|------:|------------------:|------------------:|------------:|
| [eq-shell](eq/pending/eq-shell.md) | 1371 | 170 / 54 | 134 | 39 |
...
| [eq-ui](eq/pending/eq-ui.md) | 28 | 3 / 0 | 0 | 0 |
...
| [SKS](sks/pending.md) | 445 | 83 / 9 | 2 | 18 |
...
---
_Generated deterministically (no LLM) by `.github/scripts/refresh_digest.py` · on merge + nightly · 2026-08-19 18:55 UTC._
