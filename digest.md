...
_2026-07-30 11:27 UTC · what needs your attention. Full snapshot: [suite-state.md](suite-state.md)._

## Since last refresh (2026-07-30 11:18 UTC → 2026-07-30 11:27 UTC)
...
- Merged: eq-solves-service [#652](https://github.com/eq-solutions/eq-service/pull/652) fix(audit): attribute admin archive writes to a real actor
...
---
_Generated deterministically (no LLM) by `.github/scripts/refresh_digest.py` · on merge + nightly · 2026-07-30 11:27 UTC._
