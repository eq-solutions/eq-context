...
scope: Paste-in bootstrap prompt for ChatGPT sessions — pointer to CLAUDE.md, no separate rules
...
Paste everything below this line into ChatGPT at the start of a session.
...
That's it. Everything else lives in `CLAUDE.md` — no separate ChatGPT rules to track.
