...
To fetch it, use your browsing tool or the URL above. If browsing is unavailable, ask Royce to paste the content directly.
...
**Note for ChatGPT:** You have no write access to the filesystem or GitHub. Produce patched file content for Royce to apply. Never silently substitute substrate content from your training data — if a fetch fails, say so and offer to proceed with caveats visible.
