...
- [eq/overnight-prompt-2026-05-21.md](https://raw.githubusercontent.com/eq-solutions/eq-context/main/eq/overnight-prompt-2026-05-21.md) — Self-contained brief for a multi-hour autonomous session. Mission, scope, authority, priority queue (Tenant Settings → Storage browser → Invite UX → module placeholders), definition of done. Paste at session start. (2026-05-21)
- [eq/overnight-report-2026-05-21.md](https://raw.githubusercontent.com/eq-solutions/eq-context/main/eq/overnight-report-2026-05-21.md) — **What I actually did overnight.** Cards canonical flip shipped end-to-end (data migration + Flutter Unit 4 + shell SSO flag + Netlify deploy). Sanity test + rollback path in the report. (2026-05-21)
