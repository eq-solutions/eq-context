...
1. ~~**Merge [eq-shell PR #1684](https://github.com/eq-solutions/eq-shell/pull/1684) + [eq-field PR #846](https://github.com/eq-solutions/eq-field/pull/846)**~~ — **DONE 2026-08-30.** Both merged (`824fe91f`, `8ab86d63`), both confirmed live via commit-ancestry. #846 needed a rebase first — 3 other eq-field PRs (#843/#847/#848) had merged into `docs/reflection-log.md` while it sat open; trivial append-only conflict, CI re-verified green after. Merging shipped code only — no bootstrap, no dispatch, nothing touched live data.
