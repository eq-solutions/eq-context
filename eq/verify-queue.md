...
**From:** eq-shell: field_people_iud()/field_people_removed_iud() — PR #761 push collision (0273), a separate reactivation-guard bug found live-testing with Royce (0274/PR #1571), and a second push collision investigated as harmless (2026-08-24)
...
**From:** eq-shell: Staff list quick-toggle — Supervisor ON now asks for a category — built, merged, live (2026-08-25)
...
**From:** eq-shell: link an existing site to another customer — built, merged, live (2026-08-25)
...
**From:** eq-shell: EQ Ops cost/charge-rate wiring + Edit Site "couldn't save" — three separate root causes, all fixed live (2026-08-25)
...
**From:** eq-field: TAFE holidays config could silently lose ranges when added quickly (2026-08-25)
...
**From:** eq-field: Edit Roster week-picker — pin a "Current: ..." row when paged away from the active week (2026-08-25)
...
**From:** eq-shell: per-user sidebar simplification ("Interface: Simple") — built, merged, live (2026-08-26)
...
**From:** eq-shell: self-join QR links — dead-end Delete fixed, list decluttered (2026-08-26)
...
**From:** eq-shell: Role-change audit trail + fail-loud on membership-role write failure — built, merged, live (2026-08-26)
...
**From:** eq-shell: EQ Ops quote-open P0 (dangling table join) fixed + dispatched live; mobile Commercials layout overlap fixed (2026-08-26)
...
**From:** eq-field: Leave/incident email links fixed, Approve/Reject scanner-prescan hole closed (2026-08-26)
...
**From:** eq-shell: multi-select document push + jvkn control-plane RLS gap closed (2026-08-27)
...
**From:** eq-shell: Multi-tenant Shell-login guard + roster-removal cascade — both closed, live (2026-08-27)
...
**From:** eq-shell: HEIC licence-photo uploads — built, merged, live (2026-08-27)
...
**From:** eq-shell: blank-name worker records — 3rd distinct gap found + fixed live, admin-override merged (2026-08-26)
...
**From:** eq-shell: EQ-SHELL-1A "eq-ops rpc ... failed: TypeError: Failed to fetch (ehow)" — durable fix live, all known consumers migrated (2026-08-06)
...
**From:** eq-shell: EQ Ops quote status → job status sync fixed for all 5 stages, plus a new "Target period" badge for future-dated quotes (2026-07-31)
...
**From:** eq-shell: Compliance-roster-only workers — Field access can now be switched off per worker (2026-07-30)
...
**From:** eq-field: Leave approver dropdown empty for every plain worker — field_managers security_invoker exception (2026-08-27)
...
**From:** eq-field: schedule_entries never recorded who edited a roster row (2026-08-27)
