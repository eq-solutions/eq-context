...
- [ ] **PR #1895 not merged** — auth-adjacent, needs Royce's explicit review per this repo's own CLAUDE.md, and is genuinely incomplete without the next item. _(added 2026-09-13)_
