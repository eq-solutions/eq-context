...
## eq-shell: Field-handoff stall cluster — EQ-SHELL-29 (mint-timing) and EQ-SHELL-21 (draw-notice) threshold bugs fixed; EQ-SHELL-1P/22 (stale chunk) already closed by earlier work (2026-09-13 → 09-14)
