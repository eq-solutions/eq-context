...
**Deferred:**
- [~] **Only 1 of 7 newly-wired checks (CHECK 7) has been proven against a real live violation** — the mechanism is confirmed working (issue opened + auto-closed cleanly, full detail in the sprint doc), but CHECK 6/8/9/12/13/14 remain unexercised. Lower priority now that the pattern's proven for one. _(added 2026-08-27)_
