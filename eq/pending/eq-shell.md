...
- [x] ~~A required check ("Schema drift + anon-grant + policy-lint") was blocking every PR repo-wide on a pre-existing, unrelated gap — `public.eq_cards_admin_sync_tenant_access` live on jvkn with no matching migration file~~ — **fixed**, eq-shell [PR #1629](https://github.com/eq-solutions/eq-shell/pull/1629) (merged 19:24 UTC), allowlisted as sourced in eq-cards. _(added 2026-08-26, closed 2026-08-26)_
