...
- **EQ-SHELL-1Z** ("stalled at 'minting'", tenant `madagins`) turned up in the same search — already marked `ignored` by someone, not investigated, just noting it exists as a third variant.
