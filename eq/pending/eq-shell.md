...
- [ ] **eq-service-side schema gap on madagins** (~20-25 tables, listed above) — needs an eq-solves-service-rooted session, same shape as the eq-field handoff. Not yet handed off to anyone. _(added 2026-09-09)_
