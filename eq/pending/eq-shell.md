...
- [ ] **Backend permission-CHECKING logic itself still not consolidated** — scoped in full 2026-09-16 as a 6-part cross-repo initiative (eq-roles + eq-shell + eq-field + eq-service + eq-cards), nothing built yet. See `eq/pending/cross-repo.md`'s 2026-09-16 entry for the complete picture and the delivered build prompt. _(added 2026-09-15, scoped 2026-09-16)_
