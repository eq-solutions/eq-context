...
- [ ] **27 historical review PDFs not yet attached** — root-caused why they showed no structured detail (the 2026-08-30 backfill captured a written summary per review, never the itemized answers — verified live, 100% of the 27) and shipped a way to attach the source document to any entry, but attaching is manual, one document at a time, from the browser. No bulk-import tooling built — Royce has no way to hand over the files from here (they live in his own HR folder), so this is on him whenever convenient. _(added 2026-08-30)_
