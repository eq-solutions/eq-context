...
- [ ] **One stale link found, not removed**: contact Maryam Shahpasand is still actively linked to "Equinix Hyperscale," a customer record that's since been archived. Predates this session (2026-06-28) and is harmless — an archived customer can't be quoted against — but it's a one-row cleanup if wanted. Left alone; it's a data change, not code. _(added 2026-08-20)_
