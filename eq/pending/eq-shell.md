...
- [x] ~~`eq-shell` PR #1627 (paper-trail for `0162`/`0163` + ledger correction) and its stacked follow-up PR #1628 (`CHECK 12`/`13`) — both OPEN~~ — **both merged**: [#1627](https://github.com/eq-solutions/eq-shell/pull/1627) (`02a9b405`) corrected the ledger further (0162/0163/0164 turned out to be eq-cards' own tracked migrations, not out-of-band drift — its earlier paper-trail files were removed as redundant), [#1628](https://github.com/eq-solutions/eq-shell/pull/1628) (`ea3d649a`) shipped CHECK 12/13 cleanly once #1627 landed. `scripts/check-tenant-drift.mjs`'s edit-freeze is lifted. _(added 2026-08-26, closed 2026-08-26)_
