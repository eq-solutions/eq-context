...
## eq-cards: identity-collision fix for eq_cards_link_or_create_worker — PR open, not merged, migration renumbered after a same-day collision (2026-09-16)
...
**Deferred:**
- [ ] **Migration `0178` not applied to jvkn.** Held for explicit sign-off per non-negotiable #6 — this is a `SECURITY DEFINER` worker-identity function. _(added 2026-09-16)_
