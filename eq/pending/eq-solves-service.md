...
**Deferred:**
- [ ] **PR #845 needs a rebase against current main + a fresh CI run, then Royce's review to merge.** Its diff directly fixes the remaining CI failures on main described above. _(added 2026-09-15)_
...
## eq-service: cross-tenant-sweep's remaining `service`-schema + `contacts` failures — 3 root causes found and fixed, MERGED via PR #847 (2026-09-14, confirmed 2026-09-15)

**Deferred:**
- [ ] **Real local `npm run test:integration` run once Docker is usable on this machine** — never happened; merged on real GitHub Actions CI confirmation instead (this repo's hosted runner has working Docker — only this local machine doesn't). _(added 2026-09-14)_
- [ ] **Docker Desktop's backend instability on this machine — reconfirmed 2026-09-15, a 4th+ occurrence across at least 2 calendar days.** See the escalated item in the 2026-09-15 entry below. _(added 2026-09-14)_

---

## eq-service: app_data CI-bootstrap fixture — real grants + RLS policies added (matching live exactly), MERGED via PR #847 (2026-09-14, confirmed 2026-09-15)

**Deferred:**
- [ ] **Reconcile with PR #845 — answered 2026-09-15: no reconciliation needed.** #845 is a genuinely separate bug (caller-identity/JWT resolution in the test harness), doesn't touch any file this fix touched. Still open/unmerged itself — see the 2026-09-15 entry below. _(added 2026-09-14)_
- [ ] **Docker Desktop's backend instability — reconfirmed 2026-09-15, a 4th+ occurrence across at least 2 calendar days.** See the escalated item in the 2026-09-15 entry below. _(added 2026-09-14)_
