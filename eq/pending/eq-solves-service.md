...
**Deferred:**
- [ ] **PR #775 needs CI check + merge + live verification** — same per-step process #766 went through (check CI, merge, confirm live on service.eq.solutions); not started yet for this one. _(added 2026-08-20)_
