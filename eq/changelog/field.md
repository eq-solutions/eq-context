...
## [2026-07-21] safety.js's duplicate Prestart form retired (OPEN, #516, not merged)
...
- v3.5.339, PR #516, all 11 existing test suites pass (514 assertions), CI green, deploy preview ready. **NOT merged** — flagged for review since it touches a live safety-critical form.
