...
- Review-queue tab built (PR #55, merge pending Royce): approve/dismiss UI over app_data.eq_remediation_queue (137 steward items), approvals carry intake-event lineage; sql/062 (queue RPCs + whitelist extension) staged, NOT applied to ehow.
