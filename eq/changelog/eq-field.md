...
- Swept the 7 files PR #771's changelog had already flagged as "not yet converted" for the same bug class — all 7 still had at least one live-blocking call. Rather than bundling all of it into one diff, spun off 3 separate follow-up sessions: closed out below in PR #776 (`audits.js`), PR #774, and PR #775.
