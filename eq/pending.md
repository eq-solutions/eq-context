...
- [x] **Corrected a wrong belief in the record.** A note elsewhere said the Shell-to-Cards sign-in shortcut (opening Cards inside Core) was "dead, don't revive." Real usage data shows it's actually the majority path — over half of all sign-ins in the last 3 months go through it. That old note was wrong and is being corrected.
