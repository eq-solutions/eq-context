...
**Deferred:**
- [ ] **`@typescript-eslint/no-explicit-any` (157 instances)** — the one lint-debt bucket surfaced by this cleanup that's still untouched; needs real typing work, not a mechanical fix. Not started. _(added 2026-08-03)_
