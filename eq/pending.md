...
- [ ] **Netlify Functions concurrency (the login/session endpoint) was NOT independently verified** — the database side is confirmed live; the serverless-function side of a synchronized login burst is still an open question, not measured. _(added 2026-07-22)_
