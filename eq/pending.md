...
- [ ] **Dashboard map centering — reframed 30% up per Royce's direct ask (PR #632), still awaiting his visual confirmation on the live result.** A temporary map-height bump to 900px (PR #634 — "the map window needs to be taller while I fuck around") is in place to make that testing easier. **Revert to 600px once the centering work is settled** — don't let it quietly become the new permanent height. _(added 2026-08-03)_
