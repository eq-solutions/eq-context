...
- [ ] **Not click-tested live** — the pass/fail computation was verified via a rolled-back transaction against live ehow, and the mobile card-layout fix ([PR #699](https://github.com/eq-solutions/eq-service/pull/699), merged `212b4c9`, 2026-08-11) via a static Tailwind-mirror geometry measurement — both real verification, neither is a real browser click-through. Worth a real phone/iPad pass once Shell-embedded auth is available in this environment. _(added 2026-08-10, updated 2026-08-11)_
