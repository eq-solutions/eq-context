...
- [x] **Resourcing desktop view swapped to eq-ui's `Table`** — filters, sort, global search, per-user column show/hide (persisted), CSV export, replacing the hand-rolled card list (mobile view unchanged). eq-shell [PR #1324](https://github.com/eq-solutions/eq-shell/pull/1324), build green, **not yet merged**.
- [ ] **Merge PR #1324** — reviewed, CI green, no conflicts with `main`. Just needs Royce's merge. _(added 2026-08-13)_
