...
- [x] **Full suite green (13 files, 584+ assertions).** **PR [#527](https://github.com/eq-solutions/eq-field/pull/527) OPEN, v3.5.347 — not yet merged.** SKS-only screen, gated behind tenant — needs a real click-through on the deploy preview before merge, not just the automated suite.
