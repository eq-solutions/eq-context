...
- [ ] **Merge eq-service PR #410 (contacts cutover 0167) + PR #411 (canonical-audit branch: 0166 assets fix, Shell-nav Calendar/Defects, hydration/spinner, drift guard, docs)** — DB side of both already live on ehow; the code fixes only reach prod via merge → Netlify auto-deploy. No file overlap between the two. _(added 2026-07-02)_
