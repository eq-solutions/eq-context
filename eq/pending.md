...
- [x] **Small cosmetic miss, fixed:** on the Users page, the "subcontractor" role showed in lowercase while every other role was capitalised — the page's label list was just missing that one entry. `eq-solves-service` [PR #598](https://github.com/eq-solutions/eq-service/pull/598) — open, not merged.
