...
- [ ] **Deferred: make slow pages show a rough shell instantly while the slow parts load behind it.** Real improvement for normal in-app browsing (already sharp per Royce), but doesn't address the specific "just opened it" cold-start complaint — a different problem than the one this session was chasing. Not started. _(added 2026-07-21)_
- [ ] **Deferred: a closer, measured look at trimming what's inside the app's deployed package** — some of it may be unnecessary weight slowing down every fresh start, but a rushed version of this exact kind of change broke something earlier this week and had to be undone, so it needs careful checking rather than a guess. Not started. _(added 2026-07-21)_
