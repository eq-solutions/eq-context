...
- [x] `app_data.site_credentials` (now fully orphaned, 0 rows) deliberately left in place — dropping a live table wasn't part of this fix, flagged as available cleanup, not done.
